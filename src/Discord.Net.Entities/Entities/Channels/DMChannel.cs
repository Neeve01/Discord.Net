...
#if REST
    public partial class RestDMChannel : RestChannel, ISnowflakeEntity, IDMChannel
#elif WEBSOCKET
    public partial class SocketDMChannel : SocketChannel, ISnowflakeEntity, IDMChannel
#endif
    {
...
#if REST
        internal RestDMChannel(DiscordClient discord, User recipient, Model model)
#elif WEBSOCKET
        internal SocketDMChannel(DiscordClient discord, User recipient, Model model)
#endif
        {
            Discord = discord;
            Recipient = recipient;
